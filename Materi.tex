...
\title[Logika Matematika]{Logika Matematika}
\author{Cecep Suwanda, S.Si.}
\date{April 2, 2016}
...
\section{Logika Preposisi (Kalkulus Preposisi)}
\subsection{Definisi Logika}
\begin{frame}
...
\subsection{Nilai Kebenaran Suatu Pernyataan}
\begin{frame}[shrink]
...
\subsection{Lambang Suatu Pernyataan}
\begin{frame}
...
\subsection{Lambang Nilai Kebenaran Suatu Pernyataan}
\begin{frame}
...
\subsubsection{Nilai Kebenaran Konjungsi}
\begin{frame}[shrink]
...
\subsubsection{Nilai Kebenaran Disjungsi}
\begin{frame}[shrink]
...
\subsubsection{Nilai Kebenaran Negasi}
\begin{frame}[shrink]
...
\subsubsection{Nilai Kebenaran Implikasi}
\begin{frame}[shrink]
...
\subsubsection{Nilai Kebenaran Biimplikasi}
\begin{frame}[shrink]
...
\subsubsection{Varian dari Implikasi}
\begin{frame}
...
\subsubsection{Tautologi dan Kontradiksi}
\begin{frame}[shrink]
...
\subsection{Negasi Pernyataan Majemuk}
\subsubsection{Negasi Konjungsi}
\begin{frame}
...
\subsubsection{Negasi Disjungsi}
\begin{frame}
...
\subsubsection{Negasi Implikasi}
\begin{frame}
...
\subsubsection{Negasi Biimplikasi}
\begin{frame}[shrink]
...
\subsection{Hirarki Operator Logika}
\begin{frame}
...
\section{Logika Predikat (Kalkulus Predikat)}
...
\subsection{Definisi Subterm,Subkalimat,Subekspresi}
\begin{frame}
