...
echo ============================================================
echo Compiling Silabus Document
echo ============================================================
...
if errorlevel 1 (
    ...
    if errorlevel 1 (
        ...
        latexmk -pdf -interaction=nonstopmode -output-directory="%OUTPUT_DIR%" "silabus_logika_matematika.tex"
        if errorlevel 1 (
...
pdflatex -interaction=nonstopmode -halt-on-error -output-directory="%OUTPUT_DIR%" "silabus_logika_matematika.tex"
if errorlevel 1 goto :failed

echo Running Stage 2: bibtex...
bibtex "%OUTPUT_DIR%\silabus_logika_matematika"
...
echo Final PDF: %OUTPUT_DIR%\silabus_logika_matematika.pdf
goto :end
