...
% Teks pengganti untuk bookmark PDF bila judul berisi rumus matematika
\pdfstringdefDisableCommands{%
  ...
  \def\vee{or}%
  \def\rightarrow{to}%
  \def\leftrightarrow{iff}%
  \def\forall{for all}%
  \def\exists{exists}%
  \def\land{and}%
  \def\geq{>=}%
}
% Judul bab/subbab sering memuat rumus; redam warning bookmark hyperref
\makeatletter
\def\HyPsd@Warning#1{}
\makeatother
...
% Kurangi bad box kecil pada naskah panjang
