...
\begin{catatan}
Dalam praktik pemodelan, arity yang terlalu tinggi (misalnya $> 5$) seringkali menandakan bahwa predikat perlu didekomposisi menjadi beberapa predikat yang lebih sederhana. Dekomposisi ini sejalan dengan prinsip normalisasi dalam desain basis data relasional.
\end{catatan}
...
\hline
\textbf{Aspek} & \textbf{Fakta (Ground Atom)} & \textbf{Aturan (implikasi berkuantor)} \\ \hline
