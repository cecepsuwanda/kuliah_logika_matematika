...
Peta Karnaugh 2 variabel merupakan bentuk K-Map yang paling sederhana, terdiri dari $2^2 = 4$ sel yang merepresentasikan seluruh kombinasi input dari dua variabel Boolean. Meskipun sederhana, K-Map 2 variabel berguna untuk memperkenalkan konsep dasar pengelompokan dan eliminasi variabel sebelum melangkah ke K-Map dengan lebih banyak variabel \cite{rosen2019}.
