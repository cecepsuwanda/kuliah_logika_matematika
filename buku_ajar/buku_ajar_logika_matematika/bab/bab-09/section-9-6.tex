...
Proses pembentukan bentuk kanonik SOP dari tabel kebenaran bersifat langsung: identifikasi semua baris pada tabel kebenaran yang menghasilkan output 1, tuliskan minterm untuk setiap baris tersebut, kemudian jumlahkan (operasi OR) semua minterm yang diperoleh.
...
Pembentukan bentuk kanonik POS dilakukan dengan mengidentifikasi semua baris pada tabel kebenaran yang menghasilkan output 0, menuliskan maxterm untuk setiap baris tersebut, kemudian mengalikan (operasi AND) semua maxterm yang diperoleh.
