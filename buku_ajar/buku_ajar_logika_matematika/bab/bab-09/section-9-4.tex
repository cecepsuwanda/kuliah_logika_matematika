...
Prinsip dualitas mempermudah pembuktian, karena setelah satu teorema dibuktikan, dualnya otomatis berlaku tanpa pembuktian terpisah. Sebagai contoh, jika hukum identitas versi OR ($x + 0 = x$) telah terbukti, maka dualnya, yaitu hukum identitas versi AND ($x \cdot 1 = x$), juga langsung berlaku. Perlu diperhatikan bahwa dualitas hanya menukar operator dan konstanta, tetapi \emph{tidak} menukar variabel: variabel $x$, $y$, $z$ tetap sama pada ekspresi asli dan dualnya.
...
xy + x'z + yz &= xy + x'z + yz(x + x') & \text{(Komplemen: } x + x' = 1) \\
              ...
              &= (xy + xyz) + (x'z + x'yz) & \text{(Pengelompokan ulang)} \\
...
\begin{konsep}
Hukum konsensus memiliki interpretasi intuitif: suku $yz$ disebut redundan karena informasi yang dikandungnya sudah tercakup oleh gabungan suku $xy$ dan $x'z$. Jika $y = 1$ dan $z = 1$, maka baik $x = 0$ maupun $x = 1$ sudah ditangkap oleh salah satu dari dua suku pertama.
\end{konsep}
