...
\begin{rangkuman}
Bab ini membahas realisasi fisik konsep aljabar Boolean dalam bentuk rangkaian gerbang logika digital, serta hubungan antara teori matematika dengan implementasi perangkat keras.
...
\begin{itemize}
  ...
  \item Gerbang NAND dan NOR masing-masing bersifat \textit{lengkap secara fungsional} (\textit{universal}): seluruh fungsi Boolean dapat diimplementasikan hanya menggunakan satu jenis gerbang. Hal ini memiliki implikasi penting dalam efisiensi fabrikasi semikonduktor.
  ...
  \item Analisis rangkaian (dari diagram ke ekspresi) dan analisis \textit{timing} (\textit{critical path}) merupakan aspek penting dalam verifikasi dan optimasi desain digital.
\end{itemize}
