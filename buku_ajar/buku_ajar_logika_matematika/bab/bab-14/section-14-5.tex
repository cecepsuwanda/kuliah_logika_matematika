...
Pencarian linear (\textit{linear search}) merupakan algoritma pencarian dasar yang memeriksa setiap elemen array secara berurutan hingga elemen target ditemukan atau seluruh elemen telah diperiksa. Meskipun sederhana, verifikasi formal pencarian linear menyediakan contoh yang representatif untuk menerapkan konsep loop invariant \cite{rosen2019}.
