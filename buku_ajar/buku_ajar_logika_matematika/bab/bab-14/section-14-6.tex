...
Algoritma pengurutan (\textit{sorting}) merupakan topik fundamental dalam ilmu komputer. Verifikasi formal algoritma pengurutan menyediakan studi kasus yang lebih kompleks dibandingkan pencarian linear, karena melibatkan loop bersarang (\textit{nested loops}) dan properti yang lebih rumit \cite{rosen2019}.
...
Properti kedua sering terabaikan dalam penyusunan spesifikasi, padahal penting untuk kebenaran semantik pengurutan. Program yang mengganti seluruh elemen array menjadi $0$ menghasilkan output terurut, tetapi jelas salah karena bukan permutasi dari masukan.
