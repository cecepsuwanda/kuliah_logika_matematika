...
Secara analogi, gerbang OR bekerja seperti rangkaian listrik paralel: jika salah satu sakelar ditutup (bernilai 1), arus dapat mengalir (keluaran 1). Gerbang OR juga dapat memiliki lebih dari dua masukan, di mana keluaran bernilai $1$ jika setidaknya satu dari $n$ masukan bernilai $1$.
