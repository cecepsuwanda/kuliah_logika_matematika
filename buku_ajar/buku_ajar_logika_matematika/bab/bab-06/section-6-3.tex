...
\begin{itemize}
    ...
    \item Perhatikan asimetrinya relasi bahasa keseharian manusia: statemen $S(\text{Romeo}, \text{Juliet})$ memang amat berpeluang besar True, namun hal tersebut tidak serta merta memberikan garansi matematis otomatis jika statemen balasan pertukaran letak $S(\text{Juliet}, \text{Romeo})$ lantas otomatis diklaim mematri status True pada alam semesta fiktif tersebut \cite{wiki_first_order_logic}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{3-Arity}: $B(x, y, z)$: koordinat spasial kota $x$ berlokasi membentang lurus tepat membelah posisi di tengah-tengah kota $y$ dan kota $z$.
