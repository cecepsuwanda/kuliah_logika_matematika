...
Induksi matematika ``lemah'' (\textit{weak induction}) atau disebut juga induksi biasa (\textit{ordinary induction}) merupakan bentuk induksi yang umum dipakai. Kata ``lemah'' bukan berarti metode ini kurang kuat, melainkan merujuk pada fakta bahwa langkah induksi hanya mengasumsikan kebenaran $P(k)$ untuk satu nilai $k$ (berbeda dengan induksi kuat yang mengasumsikan seluruh nilai sebelumnya) \cite{rosen2019}.
