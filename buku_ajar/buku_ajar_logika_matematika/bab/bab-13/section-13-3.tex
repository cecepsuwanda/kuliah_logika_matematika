...
Salah satu aplikasi paling umum dari induksi matematika adalah membuktikan formula tertutup (\textit{closed-form formula}) untuk penjumlahan deret. Formula tertutup menggantikan penjumlahan dengan $n$ suku menjadi satu ekspresi yang hanya melibatkan $n$, sehingga nilai penjumlahan dapat dihitung langsung tanpa menjumlahkan suku per suku \cite{rosen2019}.
