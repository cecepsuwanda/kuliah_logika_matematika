% ============================================================
% Preamble untuk Buku Ajar OBE - Logika Matematika
% ============================================================
...
% --- Grafik dan Tabel ---
\usepackage{graphicx}
\graphicspath{{figures/}{../figures/}{bab/../figures/}}
\usepackage{booktabs}
...
% --- Code Listings untuk Prolog ---
\usepackage{listings}

% Definisi warna untuk syntax highlighting
\definecolor{prologred}{rgb}{0.6,0,0}
\definecolor{prologgreen}{rgb}{0.25,0.5,0.35}
\definecolor{prologpurple}{rgb}{0.5,0,0.35}
\definecolor{prologblue}{rgb}{0.25,0.35,0.75}
\definecolor{codegray}{rgb}{0.5,0.5,0.5}
\definecolor{codebg}{rgb}{0.95,0.95,0.95}

% Definisikan Prolog untuk listings (jika belum ada)
\lstdefinelanguage{Prolog}{
  morekeywords={is, not, fail, true, :-},
  morecomment=[l]{\%},
  sensitive=false
}
% Style untuk Prolog code
\lstdefinestyle{prologstyle}{
  language=Prolog,
  basicstyle=\ttfamily\small,
  keywordstyle=\color{prologpurple},
  stringstyle=\color{prologred},
  commentstyle=\color{prologgreen},
  numbers=left,
...
\renewcommand{\lstlistlistingname}{Daftar Kode Prolog}
\renewcommand{\lstlistingname}{Kode Prolog}
\lstset{style=prologstyle}

% Environment untuk Prolog code dengan caption
\lstnewenvironment{prologcode}[1][]{
  \lstset{style=prologstyle, #1}
}{}

% Style untuk Python code (Bab 2 dan bab lain)
...
% Command untuk highlight istilah logika
\newcommand{\logic}[1]{\textbf{\textit{#1}}}

% Command untuk proposisi (inline)
\newcommand{\proposisi}[1]{\texttt{#1}}

% Command untuk code inline
\newcommand{\code}[1]{\texttt{#1}}

% Command untuk keyword Prolog
\newcommand{\keyword}[1]{\textcolor{prologpurple}{\texttt{\textbf{#1}}}}
...
% Mengurangi underfull vbox pada halaman
\raggedbottom
