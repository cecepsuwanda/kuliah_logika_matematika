...
\begin{center}
	\small
	\begin{tabular}{|p{2.2cm}|p{1.2cm}|p{7.8cm}|}
		\hline
...
\textbf{Catatan asosiativitas:} Untuk ekspresi berantai tanpa kurung, operator sejenis mengelompok menurut aturan berikut. Konjungsi $\wedge$ dan disjungsi $\vee$ bersifat \textit{asosiatif kiri}: $p \wedge q \wedge r$ dibaca $(p \wedge q) \wedge r$. Implikasi $\rightarrow$ dan biimplikasi $\leftrightarrow$ bersifat \textit{asosiatif kanan}: $p \rightarrow q \rightarrow r$ dibaca $p \rightarrow (q \rightarrow r)$. Dalam praktik, gunakan tanda kurung eksplisit untuk menghindari ambiguitas.
