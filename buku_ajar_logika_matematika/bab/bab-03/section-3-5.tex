...
\textbf{Kesimpulan Aljabar Puncaknya:} Seumur hidup jagat logika komputasi, ekuivalensi ($\equiv$) mutlak cuma terjalin antara $p \rightarrow q$ murni dengan Kontraposisi $\neg q \rightarrow \neg p$ (hukum kontraposisi) \cite{rosen2019}.
\end{contoh}
...
\begin{itemize}
    ...
    Ekuivalensi material conditional: implikasi $p \rightarrow q$ ekuivalen dengan disjungsi $\neg p \vee q$, yakni
    \begin{equation*}
        p \rightarrow q \equiv \neg p \vee q
    \end{equation*}
    (Dapat diverifikasi dengan tabel kebenaran 4 baris: keduanya bernilai F hanya saat $p$ benar dan $q$ salah.) Berdasarkan ekuivalensi ini, negasi implikasi diturunkan sebagai berikut:
    \begin{align*}
