...
\begin{enumerate}
  \item \textbf{Proyek Prolog}: Buat program Prolog yang lebih kompleks (misalnya sistem pakar sederhana, parser ekspresi logika) untuk mendemonstrasikan penerapan logika dalam praktik \cite{learn_prolog}.
...
\begin{enumerate}
  ...
  \item \textbf{Sumber Online}: Manfaatkan forall x: Calgary \cite{forallx} dan Learn Prolog Now! \cite{learn_prolog} untuk pendalaman mandiri.
  \item \textbf{Latihan Prolog}: Install SWI-Prolog dan praktik menulis fakta, aturan, serta query; gunakan tutorial interaktif di SWISH.
\end{enumerate}
...
\begin{itemize}
  ...
  \item Learn Prolog Now! \cite{learn_prolog}
  \item Spivey, \textit{An Introduction to Logic Programming Through Prolog} \cite{spivey_prolog}
  \item Simply Logical \cite{simply_logical}
\end{itemize}
