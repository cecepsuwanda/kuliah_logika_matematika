...
XOR & $F = x \oplus y$ & Output 1 jika jumlah input 1 ganjil & 2 \\ \hline
\end{tabular}
...
\begin{align*}
F &= A'BC + AB'C + ABC' + ABC \\
  &= A'BC + ABC + AB'C + ABC + ABC' + ABC & \text{(Idempoten: tambah } ABC \text{ dua kali)} \\
