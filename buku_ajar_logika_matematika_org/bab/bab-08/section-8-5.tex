...
\subsection{Requirement Pemodelan}
...
\begin{konsep}
Studi kasus ini menunjukkan bagaimana entitas (Hasan, Ahmad, dll.) dimodelkan sebagai konstanta, relasi (OrangTua) sebagai predikat arity-2, sifat (Laki, Perempuan) sebagai predikat arity-1, dan semua aturan ditranslasikan dalam bingkai implikasi berkuantor universal ($\forall$). Kemampuan penalaran otomatis ini menjadi fondasi bagi sistem pakar dan basis data deduktif.
\end{konsep}
