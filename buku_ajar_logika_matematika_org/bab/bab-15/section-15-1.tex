...
\begin{enumerate}
  ...
  \item Dalam Pemodelan Logika Predikat, fungsi proposisional ber-Arity 2 sangat lazim digunakan untuk merepresentasikan: (Sub-CPMK 4.3)
  \begin{enumerate}
...
\begin{enumerate}
  ...
  \item Jelaskan secara konseptual tiga tumpuan pilar Logika Predikat dalam dunia industri kecerdasan buatan, terutama mengenai Entitas, Kuantor/Aturan, dan Inferensi Resolusi! (Sub-CPMK 4.3)
\end{enumerate}
