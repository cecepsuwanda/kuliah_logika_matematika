...
\begin{itemize}
    ...
    \end{align*}
\end{itemize}
Hafalkan hukum *Absorpsi* ini secara khusyuk. Percayalah, hukum inilah sang Juru Selamat algoritma pemendek sirkuit terhebat manakala dihidangkan soal ujian logika nan menyiksa mata \cite{wiki_first_order_logic}.
