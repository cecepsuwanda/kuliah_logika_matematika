...
Tibalah masa penentuan pembuktian kualitas kesarjanaan logika kita \cite{wiki_first_order_logic}. Saat mesin raksasa tabel kebenaran mulai kehabisan napas karena dihadapkan variabel meraksasa puluhan iterasi, otot analitis kita ditantang berlaga senam derivasi formal.
...
\begin{tabular}{p{0.5cm} p{6.5cm} p{7cm}}
