...
Selain tiga gerbang dasar, terdapat empat gerbang logika turunan yang sangat penting dalam perancangan digital. Gerbang-gerbang ini disebut ``turunan'' karena fungsinya dapat diekspresikan menggunakan kombinasi gerbang AND, OR, dan NOT. Namun, dalam implementasi fisik, gerbang turunan justru seringkali memerlukan lebih sedikit transistor dibandingkan kombinasi gerbang dasar yang ekuivalennya, menjadikannya lebih efisien secara perangkat keras \cite{allaboutcircuits_gates}.
...
Gerbang XOR memiliki aplikasi yang sangat luas dalam sistem digital:
\begin{itemize}
