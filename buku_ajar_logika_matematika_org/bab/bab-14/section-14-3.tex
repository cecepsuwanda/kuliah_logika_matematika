...
Hubungan antara loop invariant dan induksi matematika sangat erat:
...
\textbf{1. Inisialisasi}: Sebelum loop, $sum = 0$ dan $i = 0$. Maka $sum = \sum_{j=0}^{-1} A[j] = 0$ (penjumlahan kosong). Dan $0 \leq 0 \leq n$. $\checkmark$
